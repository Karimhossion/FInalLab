/*Problem Statement : Suppose you have an array of numbers .now find out the
two elements from the array which sum will be equal to a given number (user input).
