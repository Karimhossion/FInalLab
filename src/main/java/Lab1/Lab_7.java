/*
Problem Statement : Create a java program that performy base arithmetic  operations (addition, subtraction, multiplication). The program should define multiple versions of a method named “calculate” each performing a different arithmetic operation, specially implement the following-
